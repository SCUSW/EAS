...
<html>
  ...
  <body>
    ...
    <div align="center"><a href="<%=basePath%>student!queryCourse.action?studentInfo.studentNo=${studentInfo.studentNo}">所选课程查询</a></div>
    <div align="center"><a href="<%=basePath%>student!queryAllCourse.action">在线选课</a></div>
  </body>
</html>
